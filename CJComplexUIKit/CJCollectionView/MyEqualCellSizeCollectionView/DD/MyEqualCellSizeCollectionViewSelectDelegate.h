 ...
 */
@interface MyEqualCellSizeCollectionViewSelectDelegate : MyEqualCellSizeCollectionViewBaseDelegate <UICollectionViewDelegateFlowLayout> {
...
- (id)initWithEqualCellSizeSetting:(MyEqualCellSizeSetting *)equalCellSizeSetting
          withAlwaysAloneIndexPath:(NSIndexPath *)alwaysAloneIndexPath
                   ...
                   cellSelectedBlock:(void(^)(UICollectionView *collectionView, NSIndexPath *indexPath))cellSelectedBlock NS_DESIGNATED_INITIALIZER;
