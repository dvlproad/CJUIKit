...
@implementation UIImage (CJBlur)

- (UIImage *)cj_applyLightEffect
{
    UIColor *tintColor = [UIColor colorWithWhite:1.0 alpha:0.3f];
    return [self cj_applyBlurWithRadius:30 tintColor:tintColor saturationDeltaFactor:1.8f maskImage:nil];
}
...
- (UIImage *)cj_applyExtraLightEffect
{
    ...
    return [self cj_applyBlurWithRadius:20 tintColor:tintColor saturationDeltaFactor:1.8f maskImage:nil];
}
...
- (UIImage *)cj_applyTintEffectWithColor:(UIColor *)tintColor
{
    ...
    return [self cj_applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
