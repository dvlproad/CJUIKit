...
@interface CJActionSheetTableViewCell : UITableViewCell {
...
//
@property (nonatomic, assign) BOOL isDangerCell;    /**< 是否是危险cell(默认NO；常见于该cell是删除、重新上传等操作) */
