...
@interface CJJSONProgressHUDView () {
...
@implementation CJJSONProgressHUDView
...
//+ (CJJSONProgressHUDView *)HUDForView:(UIView *)view {
//    NSEnumerator *subviewsEnum = [view.subviews reverseObjectEnumerator];
//    for (UIView *subview in subviewsEnum) {
//        if ([subview isKindOfClass:self]) {
//            CJJSONProgressHUDView *hud = (CJJSONProgressHUDView *)subview;
