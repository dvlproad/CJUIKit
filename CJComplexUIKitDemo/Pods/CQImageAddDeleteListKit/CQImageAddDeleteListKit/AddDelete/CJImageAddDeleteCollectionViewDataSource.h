//
//  CJImageAddDeleteCollectionViewDataSource.h
//  CJUIKitDemo
//
...
@class CJImageAddDeleteCollectionViewDataSource;
typedef UICollectionViewCell* (^CQPreSufItemCellAtIndexPathBlock)(CJImageAddDeleteCollectionViewDataSource *bDataSource, UICollectionView *collectionView, NSIndexPath *indexPath);

/**
 *  tableView只有一种Cell，且tableView不分区时候的dataSoure
 */
@interface CJImageAddDeleteCollectionViewDataSource : NSObject <UICollectionViewDataSource> {
