...
@interface CJFixRowColumnLayout () {
...
@implementation CJFixRowColumnLayout
...
- (CGSize)__sizeForItemWithCollectionViewSize:(CGSize)collectionViewSize
{
    ...
    } else if (self.cellWidthFromFixedColumnCount > 0 && collectionViewSize.width > 0) {
        // 每行最大列数
        NSInteger perRowMaxColumnCount = self.cellWidthFromFixedColumnCount;
    ...
    } else if (self.cellHeightFromFixedRowCount > 0 && collectionViewSize.height > 0) {
        NSInteger perColumnMaxRowCount = self.cellHeightFromFixedRowCount;
...
+ (CGFloat)heightForAllCellCount:(NSInteger)allCellCount
        ...
        withCollectionViewLayout:(CJFixRowColumnLayout *)collectionViewLayout
{
    // 计算cell的大小
                        ...
                        withCollectionViewLayout:(CJFixRowColumnLayout *)collectionViewLayout
{
    ...
    if (collectionViewLayout.cellHeightFromFixedRowCount) {
        ...
        perRowMaxShowCount = collectionViewLayout.cellWidthFromFixedColumnCount;
    }
                      ...
                      withCollectionViewLayout:(CJFixRowColumnLayout *)collectionViewLayout
{
    ...
    if (collectionViewLayout.cellHeightFromFixedRowCount) {
        ...
        perColumnMaxShowCount = collectionViewLayout.cellHeightFromFixedRowCount;
    }
