...
@interface CJFixRowColumnLayout : UICollectionViewFlowLayout {
...
@property (nonatomic, assign) NSUInteger cellWidthFromFixedColumnCount; /**< 通过每行可显示的最多列数来设置每个cell的宽度*/
...
@property (nonatomic, assign) NSUInteger cellHeightFromFixedRowCount; /**< 通过每列可显示的最多行数来设置每个cell的高度(循环的时候可设这个值为1即可) */
