...
//  2020.11.01 本类改为继承自 CJFixRowColumnLayout，为的是使用CJFixRowColumnLayout的类方法
 ...
 */
@interface CJCellHorizontalLayout : CJFixRowColumnLayout
...
//@property (nonatomic, assign) NSUInteger cellWidthFromFixedColumnCount; /**< 通过每行可显示的最多个数来设置每个cell的宽度*/
//
...
//@property (nonatomic, assign) NSUInteger cellHeightFromFixedRowCount; /**< 通过每列可显示的最多个数来设置每个cell的高度(循环的时候可设这个值为1即可) */
//
