...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CJCollectionViewLayout/CJCollectionViewLayout.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJComplexUIKit/CJComplexUIKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJContainer/CJContainer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CJImagePickerKit/CJImagePickerKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CJNetwork/CJNetwork.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CQOverlayKit/CQOverlayKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CQPopupCreater_Base/CQPopupCreater_Base.framework"
