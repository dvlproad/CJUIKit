...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/CQImageAddDeleteListKit/CQImageAddDeleteListKit_AddDeleteBundle.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/CQImageAddDeleteListKit/CQImageChooseViewBundle.bundle"
