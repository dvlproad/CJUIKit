...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../CJBaseOverlayKit/CJToast/Resources/CJToast_success.png"
  install_resource "${PODS_ROOT}/../../CJBaseOverlayKit/CJToast/Resources/CJToast_success@2x.png"
  install_resource "${PODS_ROOT}/../../CJBaseOverlayKit/CJToast/Resources/CJToast_success@3x.png"
