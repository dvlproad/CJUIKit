...
///可选：点击Item要执行的方法
@property (nonatomic, copy) void (^didTapItemBlock)(UICollectionView *collectionView, NSIndexPath *indexPath, BOOL isDeselect, CQCollectionViewFlowLayout *equalCellSizeSetting); /**< 包括 didSelectItemAtIndexPath 和didDeselectItemAtIndexPath */
                   ...
                   didTapItemBlock:(void (^)(UICollectionView *collectionView, NSIndexPath *indexPath, BOOL isDeselect, CQCollectionViewFlowLayout *equalCellSizeSetting))didTapItemBlock
{
    self = [super init];
    if (self) {
        self.flowLayout = equalCellSizeSetting;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.didTapItemBlock) {
        self.didTapItemBlock(collectionView, indexPath, NO, self.flowLayout);
    }
}

- (void)collectionView:(UICollectionView *)collectionView didDeselectItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.didTapItemBlock) {
        self.didTapItemBlock(collectionView, indexPath, YES, self.flowLayout);
    }
}
