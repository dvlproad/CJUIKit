...
{
    CGRect popupViewShowFrame = [self cj_popupInfoInView:popupSuperview withOrigin:popupViewOrigin size:popupViewSize showBeforeConfigBlock:showBeforeConfigBlock tapBlankComplete:tapBlankViewCompleteBlock];
...
/*
 *  将本View以size大小添加到showInView视图中location位置，并返回显示时候的frame
 *
 *  @param popupSuperview               弹出视图的父视图view
 *  @param popupViewOrigin              弹出视图的左上角origin坐标
 *  @param popupViewSize                弹出视图的size大小
 ...
 */
- (CGRect)cj_popupInfoInView:(UIView *)popupSuperview
                  withOrigin:(CGPoint)popupViewOrigin
                        size:(CGSize)popupViewSize
       showBeforeConfigBlock:(void(^ _Nullable)(UIView *bBlankView, UIView *bRealPopupView))showBeforeConfigBlock
      tapBlankComplete:(void(^ _Nullable)(void))tapBlankViewCompleteBlock
...
/*
 *  将当前视图添加到视图view底部，并返回显示时候的frame
 *
 *  @param popupSuperview               弹出视图的父视图view
 ...
 *  @return 视图弹出后显示的frame
 */
- (CGRect)cj_popupInfoInBottomInView:(UIView *)popupSuperview
                    ...
                    tapBlankComplete:(void(^ _Nullable)(void))tapBlankViewCompleteBlock
{
    CGFloat popupSuperviewWidth = CGRectGetWidth(popupSuperview.frame);
    CGFloat popupSuperviewHeight = CGRectGetHeight(popupSuperview.frame);
    CGSize popupViewSize = CGSizeMake(popupSuperviewWidth, popupViewHeight);
    CGFloat originX = 0;
 ...
 *  @return 视图弹出后显示的frame
 */
- (CGRect)cj_popupInfoInBottomWindowWithHeight:(CGFloat)popupViewHeight
                                    edgeInsets:(UIEdgeInsets)edgeInsets
                         showBeforeConfigBlock:(void(^ _Nullable)(UIView *bBlankView, UIView *bRealPopupView))showBeforeConfigBlock
                              tapBlankComplete:(void(^ _Nullable)(void))tapBlankViewCompleteBlock
{
