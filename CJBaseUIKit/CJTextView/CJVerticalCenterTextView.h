//
//  CJVerticalCenterTextView.h
//  CJUIKitDemo
//
//  Created by qian on 2020/12/11.
//  Copyright © 2020 dvlproad. All rights reserved.
//
//  文本竖直居中的继承自CJTextView的文本框
//  因为CJTextView除了有自身textView和placeholderTextView所以独立UITextVIew和CJTextView的文本竖直居中为不同类

#import "CJTextView.h"

NS_ASSUME_NONNULL_BEGIN

@interface CJVerticalCenterTextView : CJTextView {
