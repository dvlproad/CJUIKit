Pod::Spec.new do |s|
  ...
  s.subspec 'CJUIKitConstant' do |ss|
    ss.summary = "Constant：常量信息"
    ss.source_files = "CJBaseUIKit/CJUIKitConstant/**/*.{h,m}"
  end

  s.subspec 'UIColor' do |ss|
    ss.summary = "颜色：用来通过十六进制来设置颜色。 支持@“#123456”、 @“0X123456”、 @“123456”三种格式"
  ...
  s.subspec 'UIButton' do |ss|
    ss.summary = "按钮 及 CJBadgeButton"
    ss.source_files = "CJBaseUIKit/UIButton/**/*.{h,m}"
  end

  s.subspec 'UITextField' do |ss|
    ss.summary = "文本视图：包含文本框类别及新的自定义文本框"
  ...
  s.subspec 'UITextInputCJHelper' do |ss|
    ss.summary = "文本长度限制：UITextField 和 UITextView 会需要使用到的字符串处理方法"
  ...
  s.subspec 'CJBaseTableViewHeaderFooterView' do |ss|
    ss.summary = "列表--HeaderFooterView"
