...
#import <CQBaseUtilHelper/DemoFloatingWindow.h>
#import "TSDemoAppDelegateProtocol.h"
...
- (void)viewDidLoad {
    ...
    id<TSDemoAppDelegateProtocol> appDelegate = (id<TSDemoAppDelegateProtocol>)[[UIApplication sharedApplication] delegate];
