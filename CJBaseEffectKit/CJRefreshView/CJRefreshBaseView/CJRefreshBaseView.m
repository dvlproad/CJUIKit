...
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
        ...
        case CJRefreshBaseViewStateWillRefresh:
        {
            ...
            [UIView animateWithDuration:0.5 animations:^{
                weakSelf.stateIndicatorView.transform = CGAffineTransformMakeRotation(weakSelf.stateIndicatorViewWillRefreshStateTransformAngle);
            }];
        }
            break;
        ...
        {
            [UIView animateWithDuration:0.5 animations:^{
                weakSelf.stateIndicatorView.transform = CGAffineTransformMakeRotation(weakSelf.stateIndicatorViewNormalTransformAngle);
            }];
