Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/dvlproad/CJUIKit", :tag => "CJBaseHelper_0.1.2" }
  ...
  s.subspec 'HookCJHelper' do |ss|
    ...
    ss.subspec 'CJHookFileUploadPanel' do |sss|
      sss.source_files = "CJBaseHelper/CJBaseHelper/HookCJHelper/CJHookFileUploadPanel/**/*.{h,m}"
