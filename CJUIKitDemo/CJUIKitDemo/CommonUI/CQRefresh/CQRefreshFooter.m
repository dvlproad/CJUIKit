...
#import "CQRefreshFooter.h"
#import "UIColor+CJHex.h"

#import "CQRefreshSettingManager.h"

@interface CQRefreshFooter() {
...
@implementation CQRefreshFooter

#pragma mark - 构造方法（原本重写）
+ (instancetype)footerWithRefreshingBlock:(MJRefreshComponentRefreshingBlock)refreshingBlock
{
    return [self footerWithIdleText:[CQRefreshSettingManager sharedInstance].footerIdleText
                        pullingText:[CQRefreshSettingManager sharedInstance].footerPullingText
                     refreshingText:[CQRefreshSettingManager sharedInstance].footerRefreshingText
                     noMoreDataText:[CQRefreshSettingManager sharedInstance].footerNoMoreDataText
...
{
    CQRefreshFooter *cmp = [[self alloc] init];
