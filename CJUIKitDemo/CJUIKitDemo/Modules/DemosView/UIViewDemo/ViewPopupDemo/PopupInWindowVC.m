...
- (void)popupInWindow_center1 {
    ...
    [popupView cj_popupInCenterInView:nil animationType:CJAnimationTypeCATransform3D withSize:popupViewSize centerOffset:CGPointZero showBeforeConfigBlock:nil showComplete:^{
        NSLog(@"显示完成");
...
- (void)popupInWindow_center2 {
    ...
    CGSize popupViewSize = popupView.frame.size;
    //popupViewSize = CGSizeMake(200, 200);
    [popupView cj_popupInCenterInView:nil animationType:CJAnimationTypeCATransform3D withSize:popupViewSize centerOffset:CGPointMake(0, 30) showBeforeConfigBlock:nil showComplete:^{
        NSLog(@"显示完成");
