...
- (void)updateCurrentEnvironment:(NSString *)currentEnvironment {
    ...
    if ([self.currentEnvironment isEqualToString:@"dapi.luckycoffee.com"]) {
...
//                        @"Develop2(开发环境2)"
//                        ];
    NSArray *titles = @[@"dapi.luckycoffee.com",
                        @"dapipre.luckycoffee.com",
                        @"dapitest.luckycoffee.com",
                        @"dapitest02.luckycoffee.com"
                        ];
...
- (void)popItemChoose2:(UIButton *)button {
    ...
    [button cj_showExtendView:pop inView:self.view locationAccordingView:button relativePosition:CJPopupViewPositionBelow showComplete:^{
