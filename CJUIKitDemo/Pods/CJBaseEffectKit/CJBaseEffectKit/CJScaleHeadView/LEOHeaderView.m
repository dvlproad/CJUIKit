...
//            titleView.size = CGSizeMake(kHeaderMinWidth, kHeaderMinWidth);
            titleView.frame = CGRectMake(0, 0, kHeaderMinWidth, kHeaderMinWidth);
            
            titleView.backgroundColor = [UIColor clearColor];
//            self.navigationBarHeaderImageView.centerY = kHeaderMinWidth / 2 - 3;
            self.navigationBarHeaderImageView.center = CGPointMake(CGRectGetMidX(self.navigationBarHeaderImageView.frame), kHeaderMinWidth / 2 - 3);
...
- (UIImageView *)headerImageView {
    if (!_headerImageView) {
        ...
        _headerImageView.frame = CGRectMake(0, 0, kHeaderWidth, kHeaderWidth);
...
- (UILabel *)label {
    if (!_label) {
        ...
        CGFloat labelWidth = kSelfWidth;
        CGFloat labelHeight = 20;
        CGFloat labelOriginY = CGRectGetMaxY(self.headerImageView.frame)+15;
        CGFloat labelOriginX = 0;
        _label.frame = CGRectMake(labelOriginX, labelOriginY, labelWidth, labelHeight);
...
//        _navigationBarHeaderImageView.size = CGSizeMake(kHeaderMinWidth, kHeaderMinWidth);
        _navigationBarHeaderImageView.frame = CGRectMake(0, 0, kHeaderMinWidth, kHeaderMinWidth);
...
- (UIView *)aboveHeaderView {
    if (!_aboveHeaderView) {
        ...
        _aboveHeaderView.frame = CGRectMake(0, 0, kHeaderWidth, kHeaderWidth);
