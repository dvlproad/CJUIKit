...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../CJBaseUIKit/UIViewController/BackBarButtonItem/Resources/cjBackBarButtonItem@2x.png"
  install_resource "${PODS_ROOT}/../../CJBaseUIKit/UIViewController/BackBarButtonItem/Resources/cjBackBarButtonItem@3x.png"
  install_resource "${PODS_ROOT}/../../CJBaseUIKit/UIViewController/BackBarButtonItem/Resources/cjBackBarButtonItemGray@2x.png"
  install_resource "${PODS_ROOT}/../../CJBaseUIKit/UIViewController/BackBarButtonItem/Resources/cjBackBarButtonItemGray@3x.png"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/CQBaseUIKit/CQBaseUIKit.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/CQDemoKit/CQDemoKit_TestMethod.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/TSDemo_BaseUtilHelper/TSDemo_BaseUtilHelper.bundle"
