...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../LuckinBaseOverlayKit/CJToast/Resources/CJToast_error.png"
  install_resource "${PODS_ROOT}/../../LuckinBaseOverlayKit/CJToast/Resources/CJToast_error@2x.png"
  install_resource "${PODS_ROOT}/../../LuckinBaseOverlayKit/CJToast/Resources/CJToast_error@3x.png"
  install_resource "${PODS_ROOT}/../../LuckinBaseOverlayKit/CJToast/Resources/CJToast_success.png"
  install_resource "${PODS_ROOT}/../../LuckinBaseOverlayKit/CJToast/Resources/CJToast_success@2x.png"
  install_resource "${PODS_ROOT}/../../LuckinBaseOverlayKit/CJToast/Resources/CJToast_success@3x.png"
