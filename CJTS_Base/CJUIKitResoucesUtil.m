...
+ (UIImage *)cjts_iconImage1 {
    return [self imageWithUrl:[self cjts_iconImage1]];
}

+ (UIImage *)cjts_iconImage2 {
    return [self imageWithUrl:[self cjts_iconImage2]];
}

+ (UIImage *)cjts_iconImage3 {
    return [self imageWithUrl:[self cjts_iconImage3]];
}

+ (UIImage *)cjts_iconImage4 {
    return [self imageWithUrl:[self cjts_iconImage4]];
}

+ (UIImage *)cjts_iconImage5 {
    return [self imageWithUrl:[self cjts_iconImage5]];
}

+ (UIImage *)cjts_iconImage6 {
    return [self imageWithUrl:[self cjts_iconImage6]];
}

+ (UIImage *)cjts_iconImage7 {
    return [self imageWithUrl:[self cjts_iconImage7]];
}

+ (UIImage *)cjts_iconImage8 {
    return [self imageWithUrl:[self cjts_iconImage8]];
}
